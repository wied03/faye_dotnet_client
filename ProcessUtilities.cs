...
namespace Bsw.WebSocket4NetSslExt.Test
{
    public class ProcessUtilities
    {
        public static void KillProcessTree(Process root)
        {
            if (root != null)
            {
                ...
                GetProcessAndChildren(Process.GetProcesses(),
                                      root,
                                      list,
                                      1);
        ...
        private static void GetProcessAndChildren(Process[] plist,
                                                  Process parent,
                                                  List<Process> output,
                                                  int indent)
        {
